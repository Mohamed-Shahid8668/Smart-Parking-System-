...
g space in nearby parking lots and pay upon checkout. The system also provides analytics of the parking lot usage.
...
![reservation activity diagram](docs/workflow/ParkiT-workflow-User.png)
 ...
 activity diagram](docs/workflow/ParkiT-workflow-User.png)
